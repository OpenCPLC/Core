...
static void void_handler(void *object) { unused(object); }
...
STARTUP_WEAK void PVD_IRQHandler(void) { Default_Handler(); }
STARTUP_WEAK void RTC_TAMP_IRQHandler(void) { Default_Handler(); }
STARTUP_WEAK void FLASH_IRQHandler(void) { Default_Handler(); }
STARTUP_WEAK void RCC_IRQHandler(void) { Default_Handler(); }
STARTUP_WEAK void USB_UCPD_IRQHandler(void) { USB_Cb(USB_CbArg); }
STARTUP_WEAK void CEC_IRQHandler(void) { Default_Handler(); }
STARTUP_WEAK void TIM1_CC_IRQHandler(void) { Default_Handler(); }
STARTUP_WEAK void RNG_IRQHandler(void) { Default_Handler(); }

STARTUP_WEAK void ADC_COMP_IRQHandler(void)
{
  ADC_Cb(ADC_CbArg);
}

STARTUP_WEAK void EXTI0_1_IRQHandler(void)
{
  EXTI0_Cb(EXTI0_CbArg);
  EXTI1_Cb(EXTI1_CbArg);
}

STARTUP_WEAK void EXTI2_3_IRQHandler(void)
{
  EXTI2_Cb(EXTI2_CbArg);
  EXTI3_Cb(EXTI3_CbArg);
}

STARTUP_WEAK void EXTI4_15_IRQHandler(void)
{
...
STARTUP_WEAK void DMA_Channel1_IRQHandler(void)
{
  DMA_CH1_Cb(DMA_CH1_CbArg);
}

STARTUP_WEAK void DMA_Channel2_3_IRQHandler(void)
{
  DMA_CH2_Cb(DMA_CH2_CbArg);
  DMA_CH3_Cb(DMA_CH3_CbArg);
}

STARTUP_WEAK void DMA_Channel4_7_DMA2_IRQHandler(void)
{
...
STARTUP_WEAK void TIM1_BRK_UP_TRG_COMP_IRQHandler(void) { TIM1_Cb(TIM1_CbArg); }
STARTUP_WEAK void TIM2_IRQHandler(void) { TIM2_Cb(TIM2_CbArg); }

STARTUP_WEAK void TIM3_TIM4_IRQHandler(void)
{
  TIM3_Cb(TIM3_CbArg);
  #ifdef TIM4
  TIM4_Cb(TIM4_CbArg);
...
STARTUP_WEAK void TIM6_DAC_LPTIM1_IRQHandler(void) { TIM6_Cb(TIM6_CbArg); }
STARTUP_WEAK void TIM7_LPTIM2_IRQHandler(void) { TIM7_Cb(TIM7_CbArg); }
STARTUP_WEAK void TIM14_IRQHandler(void) { TIM14_Cb(TIM14_CbArg); }
STARTUP_WEAK void TIM15_IRQHandler(void) { TIM15_Cb(TIM15_CbArg); }
STARTUP_WEAK void TIM16_IRQHandler(void) { TIM16_Cb(TIM16_CbArg); }
STARTUP_WEAK void TIM17_IRQHandler(void) { TIM17_Cb(TIM17_CbArg); }

STARTUP_WEAK void I2C1_IRQHandler(void) { I2C1_Cb(I2C1_CbArg); }

STARTUP_WEAK void I2C2_I2C3_IRQHandler(void)
{
  I2C2_Cb(I2C2_CbArg);
  #ifdef I2C3
  I2C3_Cb(I2C3_CbArg);
...
STARTUP_WEAK void SPI2_SPI3_IRQHandler(void)
{
  SPI2_Cb(SPI2_CbArg);
  #ifdef SPI3
  SPI3_Cb(SPI3_CbArg);
...
STARTUP_WEAK void USART2_LPUART2_IRQHandler(void)
{
...
STARTUP_WEAK void USART3456_LPUART1_IRQHandler(void)
{
