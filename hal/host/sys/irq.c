...
{
  unused(tim); unused(priority); unused(handler); unused(object);
}
...
void IRQ_DisableTIM(void *tim) { unused(tim); }
void IRQ_DisableUART(void *uart) { unused(uart); }
void IRQ_DisableI2C(void *i2c) { unused(i2c); }
void IRQ_DisableSPI(void *spi) { unused(spi); }
void IRQ_DisableADC(void) {}
void IRQ_DisableDMA(DMA_CHx_t channel) { unused(channel); }
void IRQ_DisableEXTI(uint8_t line) { unused(line); }
void IRQ_DisableUSB(void) {}

//----------------------------------------------------------------------------------- Clear pending

void IRQ_ClearPendingTIM(void *tim) { unused(tim); }
void IRQ_ClearPendingUART(void *uart) { unused(uart); }
void IRQ_ClearPendingI2C(void *i2c) { unused(i2c); }
void IRQ_ClearPendingSPI(void *spi) { unused(spi); }
void IRQ_ClearPendingADC(void) {}
void IRQ_ClearPendingDMA(DMA_CHx_t channel) { unused(channel); }
void IRQ_ClearPendingEXTI(uint8_t line) { unused(line); }
