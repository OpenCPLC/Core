...
// Contract of the PWM output a host build compiles against: the types, enums, fields
...
#include "device.h"
// Part of the contract, not of this header: code including `pwm.h` for an output
// configures its pins through the same include, as it does on target
#include "gpio.h"
